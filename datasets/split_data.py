...
parser.add_argument('--path_A', default='./sawyer_collision/random_normal', help='Path to the original data')
parser.add_argument('--path_B', default='./sawyer_collision/textured', help='Path to the modified data')
parser.add_argument('--path_trained', default='./sawyer_collision/state_rollout_normal', help='path to images from the trained policy')
parser.add_argument('--output_dir', default='sawyer_collision256', help='Path the output directory for the data')
